...
<title>C.C.Donuts | CCドーナツ 当店オリジナル（5個入り）</title>
        ...
        <main>
            ...
            <div class="productDetail">
                <div class="productImg">
                    <div class="spImg">
                        <img src="images/07_sp_detail/sp_dtl_ccdonuts.png" alt="CCドーナツ 当店オリジナル（5個入り）">
                    </div>
                    <div class="pcImg">
                        <img src="images/08_pc_detail/pc_dtl_ccdonuts.png" alt="CCドーナツ 当店オリジナル（5個入り）">
                    </div>
                </div>
